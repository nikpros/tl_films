<template lang="pug">
    ul.justify-content-center(:class='paginationClasses.ul')
        li(v-if='paginationLabels.first' :class="`${paginationClasses.li} ${hasFirst ? paginationClasses.liDisable : ''}`")
            button(@click='first' :disabled='hasFirst' :class="`${paginationClasses.button} ${hasFirst ? paginationClasses.buttonDisable : ''}`" v-html='paginationLabels.first')
        li(v-if='paginationLabels.prev' :class="`${paginationClasses.li} ${hasFirst ? paginationClasses.liDisable : ''}`")
            button(@click='prev' :disabled='hasFirst' :class="`${paginationClasses.button} ${hasFirst ? paginationClasses.buttonDisable : ''}`" v-html='paginationLabels.prev')
        ...
        li(v-if='paginationLabels.next' :class="`${paginationClasses.li} ${hasLast ? paginationClasses.liDisable : ''}`")
            button(@click='next' :disabled='hasLast' :class="`${paginationClasses.button} ${hasLast ? paginationClasses.buttonDisable : ''}`" v-html='paginationLabels.next')
        li(v-if='paginationLabels.last' :class="`${paginationClasses.li} ${hasLast ? paginationClasses.liDisable : ''}`")
            button(@click='last' :disabled='hasLast' :class="`${paginationClasses.button} ${hasLast ? paginationClasses.buttonDisable : ''}`" v-html='paginationLabels.last')
</template>
